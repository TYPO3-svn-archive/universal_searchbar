...
class tx_searchbar_eID{
	...
	public function showHelp(){
		$extConf = '';
		$extConf = unserialize($GLOBALS['TYPO3_CONF_VARS']['EXT']['extConf']['searchbar']);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/searchbar/Classes/class.tx_searchbar_eID.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/searchbar/Classes/class.tx_searchbar_eID.php']);
}
