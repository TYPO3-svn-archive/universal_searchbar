...
/**
 * Plugin 'Add a Browser Searchbar' for the 'universal_searchbar' extension.
 *
 * @author	Sven Jürgens <t3@blue-side.de>
 * @package	TYPO3
 * @subpackage	tx_universalsearchbar
 */
class tx_universalsearchbar_pi1 extends tslib_pibase {
	var $prefixId      = 'tx_universalsearchbar_pi1';		// Same as class name
	var $scriptRelPath = 'pi1/class.tx_universalsearchbar_pi1.php';	// Path to this script relative to the extension dir.
	var $extKey        = 'universal_searchbar';	// The extension key.
	...
	function getSearch_url(){
		...
		return	t3lib_div::getIndpEnv(TYPO3_SITE_URL)
				. 'index.php?eID=universalsearchbar&amp;q={searchTerms}';
	}
	...
	public function getSearch_icon($image, $ext){
		...
		if(empty($image)){
			...
			$pathWithImage = 'uploads/tx_universalsearchbar/' . $image;
		}
			$withAndHeight ='';
			if($ext == 'png'){
				$withAndHeight = '16';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/universal_searchbar/pi1/class.tx_universalsearchbar_pi1.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/universal_searchbar/pi1/class.tx_universalsearchbar_pi1.php']);
}
