...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/searchbar/pi1/class.tx_searchbar_pi1_wizicon.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/searchbar/pi1/class.tx_searchbar_pi1_wizicon.php']);
}
